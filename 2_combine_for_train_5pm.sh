#!/bin/bash
# takes command as: ./2_combine_for_train.sh 229 437 110 105 461
...
let store_upto_charged=${1:-229}
let store_upto_uubar=${2:-437}
let store_upto_ddbar=${3:-110}
let store_upto_ssbar=${4:-105}
let store_upto_ccbar=${5:-461}
let store_upto=0
